...
class MissionScreen extends React.Component {
  ...
  _onViewTasksPress = () => {
    this.props.navigation.navigate('Root', { screen: 'ViewTask' })
    console.log("touch");
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.text_header}> Gestion des Missions</Text>
        </View>
        <Animatable.View
        ...
        >
          ...
          <View style={{ height: "50%", backgroundColor: COLORS.lightGray }}>
            <View style={{
              ...
              <View style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding }}>
                <Text style={{ color: COLORS.secondary, ...FONTS.h2, }}>Ajouter Mission</Text>
          ...
          <View style={{ height: "50%", backgroundColor: COLORS.lightGray }}>
            <View style={{
              ...
              <View style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding }}>
                <Text style={{ color: COLORS.secondary, ...FONTS.h2, }}>Afficher Mission</Text>
                ...
                <View style={{ flexDirection: 'row', height: '60%' }}>
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={this._onViewTasksPress}
                    >
                      <Image
                        source={icons.List}
                        resizeMode="contain"
