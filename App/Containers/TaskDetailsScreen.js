...
import { FONTS, COLORS, SIZES, icons } from "../Containers/constants";
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 80, alignItems: 'flex-end' }}>
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{ ...FONTS.h3, color: book.navTintColor }}>Task Detail</Text>
          </View>
        ...
        <View style={{ flex: 1.8, alignItems: 'center', justifyContent: 'center' }}>
          <Text style={{ ...FONTS.h2, color: book.navTintColor }}>{book.title}</Text>
          <Text style={{ ...FONTS.body3, color: book.navTintColor }}>{book.type}</Text>
        </View>
    ...
    return (
      <View style={{ flex: 1, flexDirection: 'row', padding: SIZES.padding }}>
        ...
        >
          ...
          <Text style={{ ...FONTS.body2, color: COLORS.lightGray }}>{book.summary}</Text>
        </ScrollView>
      </View>
    )
  }
