...
export const avatar_1 = require("../../Assets/images/avatar-1.jpg");
export const avatar_2 = require("../../Assets/images/avatar-2.jpg");
export const avatar_3 = require("../../Assets/images/avatar-3.jpg");
export const avatar_4 = require("../../Assets/images/avatar-4.jpg");
export const avatar_5 = require("../../Assets/images/avatar-5.jpg");
export const baked_fries = require("../../Assets/images/baked-fries.jpg");
export const burger_restaurant_1 = require("../../Assets/images/burger-restaurant.jpg");
...
export const hawaiian_pizza = require("../../Assets/images/hawaiian-pizza.jpg");
export const honey_mustard_chicken_burger = require("../../Assets/images/honey-mustard-chicken-burger.jpg");
export const hot_dog_restaurant = require("../../Assets/images/hot-dog-restaurant.jpg");
export const ice_kacang = require("../../Assets/images/ice-kacang.jpg");
export const japanese_restaurant = require("../../Assets/images/japanese-restaurant.jpg");
export const kek_lapis_shop = require("../../Assets/images/kek-lapis-shop.jpg");
export const kek_lapis = require("../../Assets/images/kek-lapis.jpg");
export const kolo_mee = require("../../Assets/images/kolo-mee.jpg");
export const nasi_briyani_mutton = require("../../Assets/images/nasi-briyani-mutton.jpg");
export const nasi_lemak = require("../../Assets/images/nasi-lemak.jpg");
export const noodle_shop = require("../../Assets/images/noodle-shop.jpg");
...
export const salad = require("../../Assets/images/salad.jpg");
export const sarawak_laksa = require("../../Assets/images/sarawak-laksa.jpg");
