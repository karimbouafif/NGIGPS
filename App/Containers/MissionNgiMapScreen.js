...
// Styles
import styles from './Styles/MissionNgiMapScreenStyle'
import { Block, Text, theme } from 'galio-framework'
import { argonTheme , Images } from '../constants'
import {BackHandler} from 'react-native';
import RoundedButton from '../../App/Components/RoundedButton'
import MissionNgiReservationModal from './MissionNgiReservationModal'
...
class MissionNgiMapScreen extends Component {
  constructor (props) {
    super(props)
    this.state = {
      showModal: false,
  ...
  async componentDidMount() {
    const promise = await this.getMyObject();
        ...
        <ScrollView style={ {paddingRight: theme.SIZES.BASE/2, }} >
          ...
          <Block row={false} card flex style={cardContainer}>
            ...
            <Modal
              ...
              <MissionNgiReservationModal     screenProps={{ toggle: this.toggleModal,reservation:this.state.selectedReservation,nav:this.props.navigation }} />
            </Modal>
...
export default MissionNgiMapScreen
